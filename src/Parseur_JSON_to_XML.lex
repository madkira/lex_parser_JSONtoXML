...
<REPORT>{STR}               {report_biome = (char*) calloc(50,sizeof(char)); report_biome = strncat(report_biome, yytext+1, yyleng -2); if(3 < range_report){text = write_open_balise(text, report_biome, 1, 5); text = strcat(text, " "); text = write_close_balise(text, report_biome, 0, 0);}}
